...
----------------------------------------------------------------------------------*/
#ifndef __TINES_HESSENBERG_FORM_Q_HPP__
#define __TINES_HESSENBERG_FORM_Q_HPP__
...
namespace Tines {
  ...
  struct HessenbergFormQ {
    ...
    device_invoke(const MemberType &member, const AViewType &A,
      ...
      return HessenbergFormQ_Internal::invoke(member, m, Aptr, as0, as1, tptr,
    ...
    invoke(const MemberType &member, const AViewType &A, const tViewType &t,
      ...
      if (active_execution_memosy_space_is_host &&
          ...
          (Q.stride(0) == 1 || Q.stride(1) == 1) && use_tpl_if_avail) {
        const int m = A.extent(0);
        ...
        r_val =
          HessenbergFormQ_HostTPL(m, Aptr, as0, as1, tptr, Qptr, qs0, qs1);
      } else {
