#ifndef __TINES_NUMERICAL_JACOBIAN_RICHARDSON_EXTRAPOLATION_HPP__
#define __TINES_NUMERICAL_JACOBIAN_RICHARDSON_EXTRAPOLATION_HPP__
  ...
  struct NumericalJacobianRichardsonExtrapolation {
    ...
    invoke(const MemberType &member,
      ...
      for (int j = 0; j < m; ++j) {
        ...
        Kokkos::parallel_for(
          Kokkos::TeamVectorRange(member, m),
          [&](const int &i) { J(i, j) = eight * (f_h(i) - f_0(i)); });
